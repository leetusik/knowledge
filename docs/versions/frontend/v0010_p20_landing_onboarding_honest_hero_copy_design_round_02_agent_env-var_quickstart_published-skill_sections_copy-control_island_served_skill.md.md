...
source: P20.REVIEW
summary: P20 landing onboarding: honest hero copy, design round 02, agent env-var quickstart + published-skill sections, copy-control island + served /SKILL.md
previous: v0009_p19_public_route_group_optional-identity_doc_public_graph_pages_publicshell_visibility_toggle_badges_copy-link_robots
---
