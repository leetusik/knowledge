...
| [ ] `P25` | `in_progress` | `pass` | Pretty public share URLs | `P25.F3` | `works/phases/active/P25` |
...
| [ ] `P25.F3` | `todo` | unclaimed-slug share UX: surface claim-your-URL state instead of silently copying the legacy URL | `fix` | `works/phases/active/P25/slices/P25.F3` |
| [ ] `P25.F4` | `todo` | member document view: consolidate explainer scroll (iframe height handshake vs AppShell layout) | `fix` | `works/phases/active/P25/slices/P25.F4` |
